...
robot = cg.get_robot_config_1(
    link1=baseLenght,       link1_offset=0.0,
    link2=armLenght,        link2_offset=0.0,
    link3=forearmLenght,    link3_offset=0.0,
    link4=handLenght,       link4_offset=0.0
)
